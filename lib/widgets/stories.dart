          ...
          itemBuilder: (BuildContext context, int index) {
            if (index == 0) {
              return Padding(
                ...
                child: _StoryCard(isAddButton: true, currentUser: currentUser),
              );
            }
...
class _StoryCard extends StatelessWidget {
  ...
  final User currentUser;
  final Story story;
  _StoryCard({Key key, this.isAddButton, this.currentUser, this.story})
      : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Stack(
      children: [
        ClipRRect(
          ...
          child: CachedNetworkImage(
            imageUrl: isAddButton ? currentUser.imageUrl : story.imageUrl,
        ...
        Positioned(
          ...
          right: 8.0,
          child: Text(
            isAddButton ? 'Add to Story' : story.user.name,
            style: TextStyle(
              color: Colors.white,
